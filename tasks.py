...
def setup(c):
    ...
    domain = edwh.tasks.check_env(key='HOSTING_DOMAIN', default='dockers.local', comment='From which domain will you access your dockers? (used to host web2py subdomain for CAS and domain certificates)')
